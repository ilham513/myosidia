		...
		<div class="main">
            ...
            <main class="content">
				<div class="container-fluid p-0">
					...
					<div class="row mb-2 justify-content-end"> <div class="col-auto"> <button type="button" class="btn btn-danger">Reset Jadwal</button> <button type="button" class="btn btn-primary">Buat jadwal otomatis</button> </div> </div>
