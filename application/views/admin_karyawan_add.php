		...
		<?php $this->load->view('component/navbar') ?>
            ...
            <main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Tambah Karyawan</h1>

                    <form action="<?=site_url('admin/karyawan_add_go');?>" method="post">
                        <div class="mb-3">
                            <label for="jamMulai" class="form-label">Nama karyawan</label>
                            <input name="nama_karyawan" type="text" class="form-control" id="jamMulai" required>
                        </div>
                        <div class="mb-3">
                            <label for="hari" class="form-label">Jenis kelamin</label>
                            <select name="jenis_kelamin" class="form-select" id="Jenis kelamin" required>
				...
				<div class="container-fluid">
					<div class="row text-muted">
						<div class="col-6 text-start">
							<p class="mb-0">
								<a class="text-muted" href="#"><strong>&copy; 2024</strong></a>								
							</p>
						</div>
					</div>
				</div>
